...
export const AppLogos = ({ name, className = "w-5 h-5" }) => {
  ...
  switch (logoName) {
    ...
    case 'whatsapp':
      return (
        <svg viewBox="0 0 24 24" fill="none" className={className}>
          <path d="M12 2C6.49 2 2 6.48 2 12C2 13.93 2.55 15.77 3.59 17.36L2.35 22L7.11 20.78C8.62 21.69 10.34 22.17 12 22.17C17.51 22.17 22 17.69 22 12.17C22 6.66 17.51 2.17 12 2.17V2Z" fill="#25D366"/>
          <path d="M16.48 14.31C16.29 14.22 15.37 13.77 15.2 13.71C15.03 13.65 14.91 13.62 14.78 13.81C14.65 14 14.28 14.44 14.17 14.56C14.06 14.68 13.95 14.7 13.76 14.61C13.57 14.52 12.96 14.32 12.23 13.67C11.66 13.16 11.27 12.53 11.16 12.34C11.05 12.15 11.15 12.04 11.24 11.95C11.32 11.87 11.43 11.74 11.53 11.63C11.63 11.52 11.66 11.44 11.72 11.31C11.78 11.18 11.75 11.06 11.7 10.97C11.65 10.88 11.24 9.95 11.07 9.56C10.91 9.19 10.75 9.24 10.63 9.23C10.52 9.22 10.39 9.22 10.26 9.22C10.13 9.22 9.92 9.27 9.74 9.46C9.56 9.65 9.05 10.11 9.05 11.05C9.05 11.99 9.76 12.9 9.86 13.03C9.96 13.16 11.24 15.2 13.19 16.04C15.14 16.88 15.14 16.6 15.47 16.58C15.8 16.56 16.53 16.13 16.71 15.62C16.89 15.11 16.89 14.67 16.83 14.57C16.77 14.47 16.67 14.41 16.48 14.31Z" fill="white"/>
        </svg>
      );
    case 'notion':
      return (
    ...
    case 'docs':
      return (
        <svg viewBox="0 0 24 24" fill="none" className={className}>
          ...
          <path d="M13 3.5V9H18.5" fill="#AECBFA"/>
    ...
    case 'meet':
      return (
        <svg viewBox="0 0 24 24" fill="none" className={className}>
          <path d="M4 6H14C15.1 6 16 6.9 16 8V16C16 17.1 15.1 18 14 18H4C2.9 18 2 17.1 2 16V8C2 6.9 2.9 6 4 6Z" fill="#00AC47"/>
          <path d="M16 10L22 7V17L16 14V10Z" fill="#00832D"/>
          <path d="M6 9H12V11H6V9ZM6 13H10V15H6V13Z" fill="white"/>
        </svg>
      );
    case 'googlekeep':
    case 'keep':
      return (
        <svg viewBox="0 0 24 24" fill="none" className={className}>
          <path d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3Z" fill="#FABB05"/>
          <path d="M7 8H17V9.5H7V8ZM7 11H17V12.5H7V11ZM7 14H13V15.5H7V14Z" fill="#5F4600"/>
        </svg>
      );
    case 'trello':
      return (
